...
Данный ноутбук можно использовать в дальнейшем для организации вопросно-ответной системы, за счет использования исключительно своего списка документов мы предотвращаем галлюцинации llm и минимизируем вероятность некорректных ответов на вопросы.
